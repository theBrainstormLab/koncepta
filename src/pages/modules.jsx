...
function Modules() {
  ...
  return (
    <div className="mt-10">
      ...
      <div className="w-[454px] h-[60px] rounded-[20px] flex px-4 mx-auto border-2 border-[var(--color-border)] mt-12 mb-0 box-border max-md:w-[90%] max-md:max-w-[454px] max-md:h-[50px] max-md:mt-8 max-md:mb-0 max-[480px]:h-[36px] max-[480px]:px-3 max-[480px]:mt-6 max-[480px]:mb-0 max-[480px]:rounded-[12px]">
